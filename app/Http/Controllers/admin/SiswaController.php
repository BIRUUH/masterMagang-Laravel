...
{
    /* Base URL endpoint API untuk data siswa.*/
    ...
    /* AJAX Endpoint: Tambah data siswa baru ke API.
    ...
    /* AJAX Endpoint: Ambil semua data siswa dari API dan kembalikan sebagai JSON.
